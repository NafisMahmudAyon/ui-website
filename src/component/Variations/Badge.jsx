		...
		return (
			<Block
				...
				<Block styles="md:w-[65%] lg:w-[73%] flex items-center justify-center gap-8">
					<Badge content={5} position="top left" variant={index + 1}>
						<Icon
					...
					<Badge content={5} position="bottom left" variant={index + 1}>
						<Icon
							icon={index == 4 ? "fa-bell" : "fa-cart-shopping"}
							iconLibrary="font-awesome"
							iconStyles="text-2xl leading-none"
						/></Badge>
					<Badge content={5} position="top right" variant={index + 1}>
						<Icon
							icon={index == 4 ? "fa-bell" : "fa-cart-shopping"}
							iconLibrary="font-awesome"
							iconStyles="text-2xl leading-none"
					...
					<Badge content={5} position="bottom right" variant={index + 1}>
						<Icon
							icon={index == 4 ? "fa-bell" : "fa-cart-shopping"}
							iconLibrary="font-awesome"
							iconStyles="text-2xl leading-none"
